          ...
          <View style={{ flex: 1 }}>
            ...
            <View style={styles.profile}>
              ...
              <View style={{ flexDirection: 'row', justifyContent: 'space-evenly' }}>
                <Text style={{ fontSize: 18, fontWeight: 'bold', color: 'grey', marginRight: 20 }}>{this.state.name}:</Text>
                <Text style={{ fontSize: 18, fontWeight: 'bold', color: 'grey', marginLeft: 20 }}>{this.state.username}</Text>
              </View>
            </View>
